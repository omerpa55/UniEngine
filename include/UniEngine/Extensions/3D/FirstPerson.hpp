...
namespace FPS {
    ...
    inline void __callback(GLFWwindow *window, double xpos, double ypos) {
    ...
    inline void getWASD(Game::Window window) {
        ...
        if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS) {
            ...
            cam_data.cameraPos -= glm::normalize(glm::cross(cam_data.cameraFront, cam_data.cameraUp)) * speed;
